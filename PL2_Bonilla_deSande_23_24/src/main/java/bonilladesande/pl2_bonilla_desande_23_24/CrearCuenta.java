...
public class CrearCuenta {
    ...
    public static void crearCuenta(boolean anfitrion, String dni, String nombre, String email, String clave, int telefono, LocalDate fechaRegistro, TarjetaCredito tarjeta, boolean vip){
